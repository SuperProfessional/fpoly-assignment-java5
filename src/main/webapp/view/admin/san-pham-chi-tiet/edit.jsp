...
<div class="container">
    <div class="row">
        <div class="col-sm-9">
            <f:form method="post" modelAttribute="sanPhamChiTiet">
                ...
                <button formaction="/san-pham-chi-tiet/update/${sanPhamChiTiet.id}" type="submit" class="btn btn-primary">Submit</button>
            </f:form>
        </div>
        <div class="col-sm-3">
            <h3>Sản Phẩm</h3>
