...
IF EXISTS(SELECT * FROM sys.databases WHERE name = 'DB_SOF203')
  BEGIN
	USE [master]
    DROP DATABASE [DB_SOF203]
  END
GO

IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'DB_SOF203')
  BEGIN
    CREATE DATABASE [DB_SOF203]
  END
GO
